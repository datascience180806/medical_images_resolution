...
Tài liệu này cung cấp thống kê chi tiết về **3 bộ dữ liệu X-quang ngực (Chest X-Ray)** được hợp nhất vào thư mục `test_images/` phục vụ cho việc đánh giá và kiểm nghiệm (Inference & Evaluation) mô hình Siêu độ phân giải ảnh y tế Swift-SRGAN trên cả mô phỏng phần mềm (CPU/GPU) và tăng tốc phần cứng (FPGA).
