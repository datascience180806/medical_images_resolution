...
\hline
Mao \textit{et al.} \cite{mao2020fdna} (2020) & Xilinx FPGA & 1512 & 5.40 W & 62.7 fps (UHD) & Fixed 13-bit & Natural Images / FSRCNN \\
Liu \textit{et al.} \cite{liu2024high} (2024) & Xilinx FPGA & 1210 & 16.85 W & 35.8 fps (FHD) & Fixed 8-bit & Natural Images / Edge SR \\
Chang \textit{et al.} \cite{chang2024hdsuper} (2024) & Xilinx FPGA & 704 & 2.08 W & 81.0 fps (FHD) & Fixed 16-bit & Natural Images / LSR \\
