...
\hline
\textbf{Metric / Feature} & \textbf{Mao \textit{et al.} \cite{mao2020fdna}} & \textbf{Liu \textit{et al.} \cite{liu2024high}} & \textbf{Chang \textit{et al.} \cite{chang2024hdsuper}} & \textbf{Huang \textit{et al.} \cite{huang2026uasr}} & \textbf{This Work} \\
\hline
Year & 2020 & 2024 & 2024 & 2026 & 2026 \\
Model Architecture & F-DNA (FSRCNN) & Edge SR & HDSuper (LSR) & UASR-A & \textbf{Compact SRCNN} \\
Target Platform & Xilinx FPGA & Xilinx FPGA & Xilinx FPGA & ZCU102 & \textbf{Zynq-7020 (PYNQ-Z2)} \\
DSPs Used & 1512 & 1210 & 704 & 181 (7.2\%) & \textbf{120 (54.5\%)} \\
Full-Chip Power & 5.40 W & 16.85 W & 2.08 W & 2.88 W & \textbf{1.438 W}$^\ast$ \\
Throughput & 62.7 fps (UHD) & 35.8 fps (FHD) & 81.0 fps (FHD) & 83.0 fps (FHD) & \textbf{157.9 patches/s}$^\dagger$ \\
Processing Latency & -- & -- & -- & -- & \textbf{6.33 ms/patch} \\
Arithmetic Precision & Fixed 13-bit & Fixed 8-bit & Fixed 16-bit & Fixed 16-bit & \textbf{PTQ Q7 (INT8)} \\
Target Domain & Natural Images & Natural Images & Natural Images & Natural Images & \textbf{Chest X-Ray Radiography} \\
\hline
\multicolumn{6}{l}{\footnotesize $^\ast$ PL dynamic power: 0.047~W. $^\dagger$ 100~MHz streaming RTL pipeline.}
\end{tabular}%
}
\end{table}
